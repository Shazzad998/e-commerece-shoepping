                ...
                <div class="card-body">
                    <form> 
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input id="value" type="text" class="form-control @error('value') is-invalid @enderror" wire:model="value"  autocomplete="value">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input id="cart_value" type="text" class="form-control @error('cart_value') is-invalid @enderror" wire:model="cart_value"  autocomplete="cart_value">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input id="expiry_date" type="text" class="form-control @error('expiry_date') is-invalid @enderror datetimepicker" wire:model="expiry_date"  >
