<div>
    ...
    <div class="py-8 lg:py-16 relative bg-gray-200">
        ...
        <div class="xl:mx-auto xl:container px-4 relative">
            <div class="flex flex-wrap xl:mx-auto xl:container">
                        ...
                        <div class="w-full 2xl:pl-48 xl:pt-1">
                            ...
                            <div class="w-full md:w-10/12 mt-3">
                                ...
                                <div class="mt-4 md:mt-8">
                                    <h2 class="text-sm md:text-base text-gray-700 font-semibold">Address</h2>
                                ...
                                <div class="mt-4 md:mt-8">
                                    <h2 class="text-sm md:text-base text-gray-700 font-semibold">Contact</h2>
                                ...
                                <div class="mt-4 md:mt-8">
                                    <h2 class="text-sm md:text-base text-gray-700 font-semibold">Email</h2>
                ...
                <div class="w-full lg:w-1/2 xl:pt-10 lg:pl-24">
                    <div class="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                        <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold tracking-wider text-gray-700">Let’s Talk</h1>
                        <div class="w-full 2xl:w-8/12 mt-3" role="form">
                            ...
                            <div class="mt-4 md:mt-8">
                                ...
                                <input class="mt-3 text-base border-2 rounded-sm w-11/12 lg:w-full xl:w-10/12 hover:border-gray-600 focus:border-gray-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="text" placeholder="Justin Timberlake" aria-label="enter your name input" />
                            </div>
                            <div class="mt-4 md:mt-8">
                                <p class="text-gray-800 text-base font-medium">Email Address</p>
                                <input class="mt-3 text-base border-2 rounded-sm w-11/12 lg:w-full xl:w-10/12 hover:border-gray-600 focus:border-gray-600 focus:outline-none border-black py-5 pl-4 text-gray-800" type="email" placeholder="example@mail.com" aria-label="enter your email input" />
                            </div>
                            <div class="mt-4 md:mt-8">
                                <p class="text-gray-800 text-base font-medium">Message</p>
                                <textarea class="mt-3 text-base border-2 rounded-sm w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-gray-600 focus:border-gray-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800" type="text" placeholder="Write us something..." aria-label="enter your message input"></textarea>
                            </div>
                            <div class="py-5">
                                <button class="py-3 md:py-5 px-5 md:px-10 bg-gray-900 text-white hover:opacity-90 ease-in duration-150 rounded-sm text-sm md:text-lg tracking-wider font-semibold focus:border-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">Send</button>
                            </div>
                        </div>
                    </div>
                </div>
